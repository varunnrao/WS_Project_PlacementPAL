...
public class DatabaseClient {
	...
	public JsonObject update(String tableName, Map<String, Object> setClause, Optional<Map<String, String>> whereClause) {
	...
	public JsonObject delete(String tableName, Optional<Map<String, String>> whereClause) {
